...
\begin{zitemize}
    ...
    \item Developed custom kubernetes operator to facilitate multiple Short Lived Application
    Testing Environments on single cluster with support for ephermeral databases using istio.
